...
function postNewDeviseWithAjax(nouvelleDevise){
    ...
    makeAjaxPostRequest( "./devise-api/v1/devises" ,
...
function putNewValueOfExistingDeviseWithAjax(deviseToUpdate){
    makeAjaxPutRequest("./devise-api/v1/devises/"+deviseToUpdate.code+"?v=true" ,
...
function deleteOldDeviseWithAjax(oldDevise){
    ...
    //***************************************
    let deleteUrl= "./devise-api/v1/devises/" + oldDevise.code + "?v=true"
...
function ajoutDevise(){
    //récuperer le contenu des zones saisies (code , name , change)
