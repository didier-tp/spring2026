...
@RequestMapping(value="/rest/api-bank/v{version}/comptes" , headers="Accept=application/json" , version="1")
//version="1"  ou autre ici ou dans application.properties as spring.mvc.apiversion.default=1 depuis spring 7
...
public class CompteRestCtrl {
   ...
   */
	...
	//Get By ID
	//V4 avec Optional à declencher en mode GET avec
	//http://localhost:8181/appliSpring/rest/api-bank/v1/comptes/1 ou 2
	@GetMapping("/{id}")
	@ApiResponse(responseCode = "200", ref = "#/components/responses/CompteResponse")
	@ApiResponse(responseCode = "404", ref = "#/components/responses/NotFoundErrorResponse")
	...
	public ResponseEntity<Compte> getCompteById(@PathVariable("id") String numeroCompte) {
		...
		//serviceCompte.findById() retourne un optional
		//et ResponseEntity.of() retourne 200/OK si l'optional est non vide
		//et 404/NOT_FOUND si l'optional est vide
	}
