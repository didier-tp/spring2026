...
public class JwtUtil {
	 ...
	 public static SecretKey signingKeyFromString(String secretKeyAsString) {
	 ...
	 public static boolean validateToken(String authToken,  String jwtSecret) {
	        try {
				SecretKey secretKey = signingKeyFromString(jwtSecret);
